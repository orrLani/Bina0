...
def plot_distance_and_expanded_wrt_weight_figure(
  ...
  #  raise NotImplementedError  # TODO: remove this line!
    p1, = ax1.plot(weights,total_cost,label="Solution cost",  c="blue",ls='-' )  # TODO: pass the relevant params instead of `...`.
    ...
    p2, = ax2.plot(weights,total_nr_expanded,label="#Expanded states", c="red",ls='-')  # TODO: pass the relevant params instead of `...`.
...
def multiple_objectives_mda_problem_experiments():
  ...
  #  exit()  # TODO: remove!
    ...
    a_2_star=AStar(MDATestsTravelDistToNearestLabHeuristic,open_criterion=lambda node :
                    node.cost.distance_cost<=max_distance_cost)
